...
- PRs through the protected-branch workflow: [PR #1 - ci: add missing Lychee link-check workflow](https://github.com/scaredofthesix/voice-word-games/pull/1) (Lychee check passed, squash-merged). Reviewed PR with teammate review: _TODO - link once a teammate reviews an open PR_.
...
- Lychee configuration: [lychee.toml](../../lychee.toml) · Workflow: [.github/workflows/links.yml](../../.github/workflows/links.yml) · Latest successful protected-branch run: [run 27288376055](https://github.com/scaredofthesix/voice-word-games/actions/runs/27288376055)
