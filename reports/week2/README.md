...
- PRs through the protected-branch workflow: [PR #1 - ci: add missing Lychee link-check workflow](https://github.com/scaredofthesix/voice-games/pull/1) (Lychee check passed, squash-merged). Reviewed PR with teammate review: _TODO - link once a teammate reviews an open PR_.
